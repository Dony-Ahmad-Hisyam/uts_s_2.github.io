...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    <!-- Isi navbar di sini -->
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Gudang</a>
    ...
    <form action="../fungsi/gudang.php" method="POST" enctype="multipart/form-data" class="w-full max-w-lg bg-gray-300 rounded-lg px-6 py-8">
      <h2 align="center" class="text-2xl mb-6">Form Input Gudang</h2>
      <div class="mb-4">
        <label class="block text-gray-700 font-bold mb-2" for="nama_barang">
          Nama Gudang
        </label>
        <input class="w-full px-2 py-2 mr-4 rounded-lg text-emerald-400  bg-slate-600 " id="harga" name="nama_gudang" type="text" placeholder="Masukkan harga barang">
      </div>
      <div class="mb-4">
        <label class="block text-gray-700 font-bold mb-2" for="nama_barang">
          Nama Barang
      ...
      <label class="block text-gray-700 font-bold mb-2" for="nama_barang">
        ...
        <select type="text" class="w-full py-2 px-2 mr-4 rounded-lg text-emerald-400  bg-slate-600 " id="id_produser" name="no_faktur" >
        <option value="<?= $result['no_faktur']; ?>" disabled selected>Pilih Tanggal Kirim</option>
