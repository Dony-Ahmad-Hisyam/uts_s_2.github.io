...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    <!-- Isi navbar di sini -->
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Costume Gudang</a>
  ...
  <tbody>
    ...
    <tr>
      <th scope="col">
        ...
        <a href="../main/edit_gudang.php?id=<?= $item['no_gudang']; ?>">   
        <div class="m-1 "> Edit</div>
        </a>
        </div>
        <div class=" w-auto rounded-lg mr-3 text-center bg-red-600 "> 
        <a href="../fungsi/deleteGudang.php?id=<?= $item['no_gudang']; ?>" >
