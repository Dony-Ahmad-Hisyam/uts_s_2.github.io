...
$data = mysqli_query($connection,"SELECT * FROM faktur INNER JOIN suplier ON faktur.no_suplier = suplier.no_suplier");
...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    <!-- Isi navbar di sini -->
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Input Faktur</a>
  ...
  <div class="flex-1 justify-center items-center">
    ...
    <form action="../fungsi/faktur.php" method="POST" enctype="multipart/form-data" class="w-full max-w-lg bg-gray-300 rounded-lg px-6 py-8">
      <h2 align="center" class="text-2xl mb-6">Form Input Faktur</h2>
      <div class="mb-4">
        <label class="block text-gray-700 font-bold mb-2" for="nama_barang">
          Nama Suplier
        </label>
        <select type="text" class="w-full py-2 mr-4 rounded-lg text-emerald-400  bg-slate-600 " id="id_produser" name="no_suplier"  >
      ...
      <div class="mb-4">
        ...
        <input class="appearance-none border rounded w-full bg-slate-600 py-2 px-3 text-emerald-400 leading-tight focus:outline-none focus:shadow-outline" id="harga" name="tanggal_kirim" type="date" placeholder="Masukkan Alamat">
      </div>
      <div class="mb-6">
      <label class="block text-gray-700 font-bold mb-2" for="harga">
          Tempo
    </label>
    <input class="appearance-none border rounded w-full bg-slate-600 py-2 px-3 text-emerald-400 leading-tight focus:outline-none focus:shadow-outline" id="harga" name="tempo" type="date" placeholder="Masukkan NO HP">
    </div>
