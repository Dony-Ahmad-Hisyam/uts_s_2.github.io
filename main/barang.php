...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    <!-- Isi navbar di sini -->
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Input Barang</a>
  ...
  <div class="flex-1 justify-center items-center">
    ...
    <form action="../fungsi/barang.php" method="POST" enctype="multipart/form-data" class="w-full max-w-lg bg-gray-300 rounded-lg px-6 py-8">
      <h2 align="center" class="text-2xl mb-6">Form Input Barang</h2>
      <div class="mb-4">
        <label class="block text-gray-700 font-bold mb-2" for="nama_barang">
          Nama Barang
        </label>
        <input class="appearance-none border bg-slate-600  rounded w-full py-2 px-3 text-emerald-400 leading-tight focus:outline-none focus:shadow-outline" id="nama_barang" name="nama_barang" type="text" placeholder="Masukkan nama barang">
      </div>
      <div class="mb-4">
        <label class="block text-gray-700 font-bold mb-2" for="harga">
          Harga Barang
        </label>
        <input class="appearance-none bg-slate-600  border rounded w-full py-2 px-3 text-emerald-400 leading-tight focus:outline-none focus:shadow-outline" id="harga" name="harga" type="text" placeholder="Masukkan harga barang">
      </div>
      <div class="mb-6">
      <label class="block text-emerald-400font-bold mb-2" for="harga">
          Foto Barang
        </label>
  ...
  <div class="flex flex-wrap justify-center ">
   <input type="file" name="foto" class="mt-7 mb-5  bg-slate-600 text-emerald-400" id="" onchange="previewImage(event)"> 
   <script>
