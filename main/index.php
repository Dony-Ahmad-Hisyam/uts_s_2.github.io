...
<div class="h-screen flex">
  ...
  <div class="flex-1">  
    <div class="flex flex-wrap justify-center w-full">
        <img src="../upload/<?php echo $foto; ?>" class="w-2/12 mt-10 border border-white rounded-full flex justify-center items-center h-3/4" alt="Foto  ">
    </div>
    <div class="flex flex-wrap justify-center text-center w-full mt-10 text-5xl text-gray-300">
    <h1>
        Selamat Datang Suplier <?php echo $nama; ?>!<br>
    </h1>
    </div>
    <div class="flex flex-wrap justify-center text-center w-full mt-10 text-2xl text-gray-300">
        <div class="w-1/2">
