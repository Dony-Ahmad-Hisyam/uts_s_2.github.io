...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    ...
    <a href="./client.php" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Dashboard</a>
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Faktur</a>
  ...
  <div class="w-full flex-1 shadow-xl rounded-3xl text-gray-300">
    <div class=" text-center font-serif font-bold text-3xl mt-10">Data Faktur</div>
  ...
  <tbody>
    <tr>
      <th scope="col">
        ...
        <th scope="col">
        <div class=" w-full "> <?= $item['nama_suplier']  ?>
        </div></th>
        <th scope="col">
        <div class=" w-full "> <?= $item['tanggal_kirim']  ?>
        </div></th>
        <th scope="col">
        <div class=" w-full "> <?= $item['tempo']  ?>
        </div></th>
        </tr>
