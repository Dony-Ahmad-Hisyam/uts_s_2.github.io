...
<nav class="w-1/5 bg-emerald-700 overflow-y-scroll">
    <!-- Isi navbar di sini -->
    <a href="./client.php" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Dashboard</a>
            ...
            <a href="#" class="text-gray-300 bg-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Barang</a>
    ...
    <div class="w-full flex-1 rounded-3xl text-gray-300">
    <div class=" text-center pt-5 font-serif font-bold text-3xl ">Data Barang</div>
    <div class="text-center m-4 ">
    <table align="center" class="w-full justify-center shadow-xl mt-3  bg-gray-700 rounded-xl" >
  ...
  <tbody>
    ...
    <tr>
      <th scope="col">
        ...
        <th scope="col">
        <div class=" w-full flex justify-center"><img class="w-36 h-36 mt-2 rounded-md " src="../upload/<?php echo $item['foto']; ?> ">
        </div></th>
        <th scope="col">
